...
// --- Data Declarations ---
const TEAM = [
  { name: '张伟', init: 'ZW', color: '#6366f1' },
  { name: '李娜', init: 'LN', color: '#f59e0b' },
  { name: '王强', init: 'WQ', color: '#22c55e' },
  { name: '赵敏', init: 'ZM', color: '#ef4444' },
  { name: '陈晨', init: 'CC', color: '#3b82f6' },
  { name: '刘洋', init: 'LY', color: '#a855f7' }
];
